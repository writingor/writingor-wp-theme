...
<div class="writingor--layout-10">
	<div class="writingor--layout-10__container writingor--container"></div>
		<?
		...
		<div class="writingor--layout-10__body">
			...
			<form method="post" class="writingor--layout-10__col-1 woocommerce-ResetPassword lost_reset_password">
